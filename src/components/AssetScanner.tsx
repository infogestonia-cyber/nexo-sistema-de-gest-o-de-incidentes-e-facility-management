  ...
  return (
    <div className="max-w-md mx-auto space-y-8 page-enter pt-10">
      <div className="text-center space-y-2">
        <div className="w-16 h-16 bg-emerald-500 rounded-3xl mx-auto flex items-center justify-center text-white shadow-xl shadow-emerald-500/20 mb-4">
          <Scan size={32} />
        </div>
      ...
      <form onSubmit={handleSearch} className="space-y-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 bg-brand-surface border border-brand-border rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 text-sm text-white shadow-inner"
          />
        </div>
        <button 
          type="submit"
          disabled={loading}
          className="w-full py-4 bg-emerald-500 text-white rounded-2xl font-bold uppercase tracking-widest text-xs hover:bg-emerald-600 transition-all shadow-xl shadow-emerald-500/20 disabled:opacity-50"
        >
      ...
      <AnimatePresence mode="wait">
        ...
        {foundAsset && (
          <motion.div
            ...
            className="bg-brand-surface border border-brand-border overflow-hidden rounded-3xl shadow-2xl"
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <button 
                ...
                className="w-full py-4 border border-emerald-500/30 text-emerald-500 rounded-2xl font-bold uppercase tracking-widest text-[10px] hover:bg-emerald-500 hover:text-white transition-all flex items-center justify-center gap-2"
              >
                Abrir Ficha Técnica
                <ArrowRight size={14} />
              </button>
