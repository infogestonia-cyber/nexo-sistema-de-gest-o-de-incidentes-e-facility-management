          ...
          {filteredAssets.map((asset) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <div className={`px-2 py-0.5 rounded-lg text-[9px] font-bold uppercase tracking-wider ${asset.probabilidade_falha === 'Alta' ? 'bg-red-500/10 text-red-500 border border-red-500/20' :
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <div className={`w-1.5 h-1.5 rounded-full ${asset.probabilidade_falha === 'Alta' ? 'bg-red-500' :
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            >
              ...
              <div className="p-6 border-t border-brand-border shrink-0 bg-brand-surface">
                ...
                >
                  {submitting ? (
                    <><div className="w-3 h-3 border-2 border-white/20 border-t-white rounded-full animate-spin"></div> A processar...</>
                  ) : 'Confirmar Registo'}
                </button>
              </div>
            </motion.div>
